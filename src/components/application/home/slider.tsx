...
const Slider = () => {
  ...
  return (
    <div className="flex h-max z-10 overflow-hidden border-t">
      <div className="relative transform transition-all duration-50000 bg-white w-full tablet:h-[30vh] h-[60vh] overflow-hidden">
        <div className="overflow-x-hidden relative w-full h-full">
          ...
          <Link
            href="/events/create"
            className="text-sm px-6 py-3 rounded bg-white/90 hover:bg-white text-primary-boulder700 font-semibold absolute bottom-7 tablet:left-5 left-20"
          >
            Create your next event
          </Link>
        </div>
        <div className="absolute bottom-10 flex justify-center tablet:justify-end pr-5 tablet:pr-0 items-center mt-20 space-x-1 w-full">
