...
import Quote from "@/assets/images/reviews/quote.svg";
...
export default function Reviews() {
  ...
  return (
    <section
      ...
      className={`w-full max-w-[1650px] mx-auto sticky z-20 h-max bg-white items-center overflow-hidden large:py-[168px] tablet:py-14 py-24 flex flex-col ${
              ...
              >
                ...
                >
                  <div className="w-full flex flex-col h-[calc(100%-80px)] gap-4">
                    <div className="w-full flex items-center gap-[5.4px]">
                      {item.ratings.map((rating: any) => {
                        return <Image src={Star} alt="" key={rating} />;
                      })}
                    </div>
                  ...
                  <div className="w-full h-max items-end flex justify-between">
                    ...
                    <Image src={Quote} alt="" className="translate-y-6" />
                  </div>
                </div>
              </div>
            );
