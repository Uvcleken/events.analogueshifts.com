  ...
  return (
    <div className="w-full pb-5 flex flex-col gap-2.5">
      ...
      <div className={`w-full relative flex items-center h-12`}>
        <i className={"absolute left-5  text-base text-gray-400 w-8 "}>
          {icon}
        </i>

        <input
          className={`password-input w-full rounded-2xl bg-white border border-black/10 outline-1 outline-background-darkYellow h-full pl-12  text-base font-normal text-gray-400 ${
